...
# Internet Gateway (only for gateway-vm)
...
# Private subnet (caller-vm and inference-vm live here)
...
# Elastic IP + NAT Gateway (lets private VMs reach internet to install packages)
...
# Route table for private subnet (goes through NAT)
